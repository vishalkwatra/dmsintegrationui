					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI for DMS Integration",
									"targetURL": "#dmsintui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"dmsintui-display": {
								"semanticObject": "dmsintui",
								"action": "display",
								"description": "UI for DMS Integration",
								"title": "UI for DMS Integration",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dmsintui",
									"url": sap.ui.require.toUrl("dmsintui")
								}
							}
						}
					}
